...
This script assumes that you have You have cloned the git repository, [configured Singularity](../setup/docker/), set up [IGV](../setup/igv), and prepared the [WGBS data & genome](../setup/wgbs_setup/).
...
Use IGV to inspect the fit ([basic instructions for TACC](../setup/igv)).
Load the indexed Amil-lambda genome, then the sorted bam file.
You'll need to zoom into the tracks.
