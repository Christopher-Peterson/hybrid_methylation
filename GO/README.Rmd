...
dss_loc = "snps/tg_md/dss"
```

# Gene Ongology analysis

The goal here is to see GO terms shed light on the mixed heritability (as revealed in DSS).
...
Alternately, see if we can skip steps 1-2 by downloading the ensembl file for Amil v 2.1.
...
I've downloaded and unzipped the GO_MWU repository into the GO directory; some adjustments have been made to the script re: filenames. 
