...
mkdir -p $WD # If this direc exists, the run will fail.
ln -sf $ROOTDIR/$VCF $WD/parents.vcf
ln -sf $ROOTDIR/scripts $WD/scripts
...
# Write out the
echo "GENOME_FOLDER=$GENOME_FOLDER" >  ${ROOTDIR}/masked_genomes/registry/${PARENTS}.sh
