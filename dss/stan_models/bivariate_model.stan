...
model {
  ...
  if (!prior_only) {
    ...
    // for (n in 1:N_deltao1) {
      ...
      mu_deltao[n] += [ bsp_deltao1[1], bsp_deltao2[1] ] .* Yl_deltap1[n];
...
generated quantities {
  ...
  vector[N] resid_1 = Yl_deltao1 - bsp_deltao[1] * Yl_deltap1;
  vector[N] resid_2 = Yl_deltao2 - bsp_deltao[2] * Yl_deltap1;
}
