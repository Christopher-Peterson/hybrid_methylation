...
First, we're going to create a subset of the fastqs to test the trimming on:
...
I'm trying an alternate trimming method (Trim Galore) in an attempt to improve alignment quality.
```{bash, eval = FALSE, echo = TRUE}
