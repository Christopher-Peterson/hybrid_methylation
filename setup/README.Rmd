...
Given the difficulty in getting Julia to work wtih a docker image, I'm just going to try running it natively.
This project requires Julia 1.3.1 to run CpelAsm/InformME.jl
