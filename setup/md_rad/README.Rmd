...
This section documents acquiring the md-RAD reads, trimming them, and aligning them. 
...
Next, unzip and concatenate the paired files. We're just focusing on adults for this one.
