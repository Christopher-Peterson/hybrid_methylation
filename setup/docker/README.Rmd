...
The GAM components (the temporary ones, at least) use an image Christopher originally created for a different project; it's being set up here for both local and TACC use.
